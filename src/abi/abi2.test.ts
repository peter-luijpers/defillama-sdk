...
test("multiCall", async () => {
  ...
  ).toEqual(["14625620499802070062319404", "309111153048197706206870"]);
});
...
test("multiCall with abi", async () => {
  expect(
    await multiCall({
      calls: ["0x7f1c7aa2ce3cbc533afc7934156d4ae20d313808"],
      abi: {
        constant: true,
        inputs: [],
...
test("multiCall with multiple return values and reverts", async () => {
  ...
  const expectedResponse = [
    ["22703861331", "3120786254041482210638", "1668779963"],
    null,
    ["1428900635496571696616098", "6976400025268132321919", "1668782291"],
  ];
