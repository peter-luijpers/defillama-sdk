...
test("getProvider - custom chain", async () => {
  ...
  const clvObject = new ethers.JsonRpcProvider(clvRPC, {
    name: "clv-llama-test",
    chainId: 1024,
  });
...
test.skip("wss provider", async () => {
  ...
  const usdcDecimals = await wssapi.call({
    abi: "erc20:decimals",
    target: "0x931715FEE2d06333043d11F658C8CE934aC61D0c",
  });
  const usdcDecimals1 = await wssapi.call({
    abi: "erc20:decimals",
    target: "0x931715FEE2d06333043d11F658C8CE934aC61D0c",
  });
  const usdcDecimals2 = await wssapi.call({
    abi: "erc20:decimals",
    target: "0x931715FEE2d06333043d11F658C8CE934aC61D0c",
  });
  const usdcDecimals3 = await wssapi.call({
    abi: "erc20:decimals",
    target: "0x931715FEE2d06333043d11F658C8CE934aC61D0c",
  });
...
test("dogechain provider (quorum issue)", async () => {
  ...
  await api.call({
    ...
    target: "0x8e5dff1c121F661971d02950698f8c5EFc3DfA78",
  });
});
